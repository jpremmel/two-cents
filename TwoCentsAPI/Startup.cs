...
namespace TwoCentsAPI
{
    public class Startup
    {
        ...
        {
            services.AddCors();
            services.AddDbContext<TwoCentsAPIContext>(opt =>
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Two Cents API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Two Cents API V1");
            });
